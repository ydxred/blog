...
<div class="max-w-3xl mx-auto">
    ...
    <div class="rounded-2xl border border-slate-200/80 bg-white p-5 sm:p-7 mb-10 shadow-sm ring-1 ring-slate-200/50" x-data="postForm()">
        <form action="<?php echo e(route('post.store')); ?>" method="POST" enctype="multipart/form-data" x-ref="form">
            <?php echo csrf_field(); ?>
            <div class="flex gap-4 sm:gap-5">
                <div class="flex-shrink-0">
                    <?php if (isset($component)) { $__componentOriginal8ca5b43b8fff8bb34ab2ba4eb4bdd67b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8ca5b43b8fff8bb34ab2ba4eb4bdd67b = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.avatar','data' => ['user' => auth()->user()]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                ...
                <div class="flex-1 min-w-0 pt-1">
                    ...
                    <div x-show="showTags" x-cloak class="flex flex-wrap gap-2 mt-4">
                        <?php $__currentLoopData = \App\Models\Tag::orderBy('sort_order')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <label class="cursor-pointer">
                                <input type="checkbox" name="tags[]" value="<?php echo e($tag->id); ?>" class="hidden peer">
                                <span class="inline-block px-3 py-1 rounded-full text-xs font-medium border transition-all
                                      ...
                                      @click="$nextTick(() => { $el.style.backgroundColor = $el.previousElementSibling.checked ? '<?php echo e($tag->color); ?>' : ''; $el.style.borderColor = $el.previousElementSibling.checked ? '<?php echo e($tag->color); ?>' : ''; $el.style.color = $el.previousElementSibling.checked ? 'white' : ''; })">
                                    <?php echo e($tag->name); ?>
    ...
    <div class="flex flex-wrap gap-2.5 mb-8">
        <a href="<?php echo e(route('moments')); ?>"
           class="inline-flex items-center px-4 py-1.5 rounded-full text-sm font-medium transition-all <?php echo e(!$currentTag ? 'bg-gradient-to-r from-emerald-500 to-teal-500 text-white shadow-md shadow-teal-500/20' : 'bg-white text-slate-600 ring-1 ring-slate-200 hover:ring-slate-300 hover:bg-slate-50'); ?>">
            全部
        </a>
    ...
    <div id="posts-container" class="space-y-6 relative before:absolute before:inset-y-0 before:left-7 sm:before:left-[2.1rem] before:w-px before:bg-slate-200/80 before:-z-10">
        <?php if($posts->count()): ?>
            <?php echo $__env->make('front.partials.post-list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php else: ?>
    ...
    <div id="load-more-wrapper" class="mt-10 flex flex-col items-center gap-3">
        <?php if($posts->hasMorePages()): ?>
            <button id="load-more-btn"
                    data-next-url="<?php echo e($posts->appends(request()->query())->nextPageUrl()); ?>"
        ...
        <p id="posts-stats" class="text-xs text-stone-400 mt-2">
            已显示 <span id="shown-count"><?php echo e($posts->count()); ?></span> / <?php echo e($posts->total()); ?> 条
        </p>
    </div>
    <?php endif; ?>
...
<?php echo $__env->make('front.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/ydxred.com/resources/views/front/index.blade.php ENDPATH**/ ?>