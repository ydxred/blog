...
<head>
    ...
    <title><?php echo e(config('app.name')); ?> - 管理后台</title>
        ...
        <aside class="w-full md:w-64 bg-gray-900 text-white flex-shrink-0"
            ...
            <nav class="mt-2 pb-4 md:pb-0">
                <a href="<?php echo e(route('admin.dashboard')); ?>"
                   class="flex items-center px-6 py-3 text-sm <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-gray-800 text-white border-l-4 border-blue-500' : 'text-gray-300 hover:bg-gray-800'); ?>">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                    仪表盘
                </a>
                <a href="<?php echo e(route('admin.articles.index')); ?>"
                   class="flex items-center px-6 py-3 text-sm <?php echo e(request()->routeIs('admin.articles.*') ? 'bg-gray-800 text-white border-l-4 border-blue-500' : 'text-gray-300 hover:bg-gray-800'); ?>">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                    文章管理
                </a>
                <a href="<?php echo e(route('admin.posts.index')); ?>"
                   class="flex items-center px-6 py-3 text-sm <?php echo e(request()->routeIs('admin.posts.*') ? 'bg-gray-800 text-white border-l-4 border-blue-500' : 'text-gray-300 hover:bg-gray-800'); ?>">
                ...
                <a href="<?php echo e(route('admin.tags.index')); ?>"
                   class="flex items-center px-6 py-3 text-sm <?php echo e(request()->routeIs('admin.tags.*') ? 'bg-gray-800 text-white border-l-4 border-blue-500' : 'text-gray-300 hover:bg-gray-800'); ?>">
                ...
                <a href="<?php echo e(route('admin.comments.index')); ?>"
                   class="flex items-center px-6 py-3 text-sm <?php echo e(request()->routeIs('admin.comments.*') ? 'bg-gray-800 text-white border-l-4 border-blue-500' : 'text-gray-300 hover:bg-gray-800'); ?>">
                ...
                <a href="<?php echo e(route('admin.visits.index')); ?>"
                   class="flex items-center px-6 py-3 text-sm <?php echo e(request()->routeIs('admin.visits.*') ? 'bg-gray-800 text-white border-l-4 border-blue-500' : 'text-gray-300 hover:bg-gray-800'); ?>">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg>
                    访问记录
                </a>
                <a href="<?php echo e(route('admin.settings.about')); ?>"
                   class="flex items-center px-6 py-3 text-sm <?php echo e(request()->routeIs('admin.settings.*') ? 'bg-gray-800 text-white border-l-4 border-blue-500' : 'text-gray-300 hover:bg-gray-800'); ?>">
...
<?php /**PATH /var/www/ydxred.com/resources/views/admin/layouts/app.blade.php ENDPATH**/ ?>