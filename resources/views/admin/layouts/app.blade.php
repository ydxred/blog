    ...
    <aside class="fixed inset-y-0 left-0 z-50 w-64 bg-gray-900 text-white transform transition-transform duration-300 ease-in-out md:translate-x-0 overflow-y-auto flex flex-col"
        ...
        <nav class="mt-2 flex-1 pb-4">
            ...
            <a href="{{ route('admin.media.index') }}"
               class="flex items-center px-6 py-3 text-sm {{ request()->routeIs('admin.media.*') ? 'bg-gray-800 text-white border-l-4 border-blue-500' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }}">
            ...
            <a href="{{ route('admin.settings.site') }}"
               class="flex items-center px-6 py-3 text-sm {{ request()->routeIs('admin.settings.site') ? 'bg-gray-800 text-white border-l-4 border-blue-500' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }}">
